...
export default async function GeblokkeerdPage() {
  const t = await getTranslations("Geblokkeerd");
  const whatsappLink = buildWhatsAppLink(
    "Hoi, mijn InNederland.ai account is geblokkeerd. Kunnen jullie dit bekijken?",
  );
    ...
    <div className="flex min-h-screen flex-col items-center justify-center gap-8 bg-navy-50 px-4 py-12">
      ...
      <Card className="w-full max-w-lg">
        <CardContent className="flex flex-col items-center gap-5 text-center">
          <span className="flex size-14 items-center justify-center rounded-full bg-red-50 text-flag-red">
